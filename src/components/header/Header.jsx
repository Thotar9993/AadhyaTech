...
import logo from '../../assets/Logos/aadhya-logo.png'
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-4 sm:px-8 py-4 w-full max-w-[100vw] backdrop-blur-md shadow-lg" style={{background: '#0b2545', color: '#fff'}}>
      <div className="flex items-center gap-3">
        <img src={logo} alt="Aadhya Tech Logo" className="h-16 w-auto object-contain" />
        <span className="hidden sm:inline text-lg font-bold text-white">Aadhya Tech</span>
      </div>
      ...
      >
        <div className="flex items-center justify-between px-4 py-4 border-b border-white/10">
          <div className="flex items-center gap-3">
            <img src={logo} alt="Aadhya Tech Logo" className="h-12 w-auto object-contain" />
          </div>
          <button
            type="button"
